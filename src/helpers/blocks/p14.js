...
/**
 * Generate P14 form (block_images/p14.png)
 *
 ...
 */
export function generateP14Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P14 form");
...
export default generateP14Form;
