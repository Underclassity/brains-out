...
/**
 * Generate P27 form (block_images/p27.png)
 *
 ...
 */
export function generateP27Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P27 form");
...
export default generateP27Form;
