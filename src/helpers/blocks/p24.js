...
/**
 * Generate P24 form (block_images/p24.png)
 *
 ...
 */
export function generateP24Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P24 form");
...
export default generateP24Form;
