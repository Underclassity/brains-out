...
/**
 * Generate P37 form (block_images/p37.png)
 *
 ...
 */
export function generateP37Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P37 form");
...
export default generateP37Form;
