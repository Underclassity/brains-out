...
/**
 * Generate P22 form (block_images/p22.png)
 *
 ...
 */
export function generateP22Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P22 form");
...
export default generateP22Form;
