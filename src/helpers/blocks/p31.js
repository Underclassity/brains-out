...
/**
 * Generate P31 form (block_images/p31.png)
 *
 ...
 */
export function generateP31Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P31 form");
...
export default generateP31Form;
