...
/**
 * Generate P23 form (block_images/p23.png)
 *
 ...
 */
export function generateP23Form(size = 0.2, parts = [], isSimple = false) {
  // console.log("Generate P23 form");
...
export default generateP23Form;
